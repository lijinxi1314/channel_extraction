...
#define POS 1
#define NEG 0
#define OUT_POS_C45 "F:/MIT/MIT/channel/positive/pos_Robinson/NorthEast"
#define OUT_NEG_C45 "F:/MIT/MIT/channel/negative/neg_Robinson/NorthEast"
...
public:
    ...
    canny(String, int i, int type); //Constructor
	Mat toGrayScale();
